...
ActiveRecord::Schema.define(version: 2020_11_11_004010) do
  ...
  create_table "okiniiris", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "okiniiri_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["okiniiri_id"], name: "index_okiniiris_on_okiniiri_id"
    t.index ["user_id", "okiniiri_id"], name: "index_okiniiris_on_user_id_and_okiniiri_id", unique: true
  ...
  add_foreign_key "okiniiris", "okiniiris"
